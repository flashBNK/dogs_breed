...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('friendliness__range', (1, 5)), ('shedding_amount__range', (1, 5)), ('exercise_needs__range', (1, 5)), ('trainability__range', (1, 5))), name='breed_rating_range')],
            },
        ),
        migrations.CreateModel(
            name='Dog',
            fields=[
                ...
                ('age', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(35)])),
